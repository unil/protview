			...
			<div id="settingsTabs">
				...
				<div>
					<form id="transmembraneSettingsForm" class="form-horizontal">
						...
						<div class="control-group">
							<label for="domain" id="domain-label" class="control-label">Membrane domains</label>
							<div class="controls">
								From : <input type="text" class="input-mini inline"
									name="from-1" id="from-1"> To : <input type="text"
									class="input-mini inline" name="to-1" id="to-1">
							</div>
							<div class="controls">
								From : <input type="text" class="input-mini inline"
									name="from-2" id="from-2"> To : <input type="text"
									class="input-mini inline" name="to-2" id="to-2">
							</div>
							<div class="controls">
								From : <input type="text" class="input-mini inline"
									name="from-3" id="from-3"> To : <input type="text"
									class="input-mini inline" name="to-3" id="to-3">
							</div>
							<div class="controls">
								From : <input type="text" class="input-mini inline"
									name="from-4" id="from-4"> To : <input type="text"
									class="input-mini inline" name="to-4" id="to-4">
							</div>
							<div class="controls">
								From : <input type="text" class="input-mini inline"
									name="from-5" id="from-5"> To : <input type="text"
									class="input-mini inline" name="to-5" id="to-5">
							</div>
						</div>
						<div>
							<input type="submit" value="Save" />
